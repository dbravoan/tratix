...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Documents & Contract Evidences Storage Disk
    |--------------------------------------------------------------------------
    |
    | Defines the disk where private contract documents, ID card scans, and
    | evidence audit trails are stored (local, s3, or r2).
    |
    */
